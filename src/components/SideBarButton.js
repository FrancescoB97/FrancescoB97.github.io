  ...
  return (
    <div className="w-auto h-auto">
      ...
      <Link to="/"><Button variant={props.title === "AboutMe" ?  "dark" : "outline-dark"} id="btn-style" >
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-fingerprint" viewBox="0 0 16 16">
...
function SocialsBtn(props) {
  return (
    ...
    <OverlayTrigger
        ...
        placement="right">
      <Link to="/Socials"><Button variant={props.title === "Socials" ?  "dark" : "outline-dark"} id="btn-style">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="48"
          height="48"
