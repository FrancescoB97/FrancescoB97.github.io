  ...
  return (
    ...
    <div className="mt-5 pt-4">
      ...
      <OverlayTrigger
        ...
        placement="bottom">
        <Button className="mt-3" size="lg" variant="outline-danger" onClick={() => openInNewTab("https://www.youtube.com/watch?v=Tmopv2N2nVM&list=PLiUM5P7jBVacB_7z4eVBh8wCqPTYpl-Re")}>
