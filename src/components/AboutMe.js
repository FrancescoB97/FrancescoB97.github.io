      ...
      <div className="d-flex flex-wrap mx-2 mt-5">                   
            ...
            <div className="d-flex align-items-center rcorners center-block p-1">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[0]}</p>                   
              </div>                    
            </div>
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[1]}</p>                    
              </div>                    
            </div>
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[2]}</p>                      
              </div>                    
            </div>
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-headset-vr" viewBox="0 0 16 16">
                ...
                <p>{props.t('interests', { returnObjects: true })[3]}</p>                     
              </div>                    
            </div>   
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[4]}</p>                     
              </div>                    
            </div>                   
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[5]}</p>                   
              </div>                    
            </div> 
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[6]}</p>                     
              </div>                    
            </div> 
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                ...
                <p>{props.t('interests', { returnObjects: true })[7]}</p>                     
              </div>                    
            </div> 
      </div>
    </div>
