    ...
    <h2>I miei interessi</h2>  
      ...
      <div className="d-flex flex-wrap mx-2 mt-5">                   
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-book" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-hypnotize" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-terminal" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-cpu" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-heart-pulse" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-puzzle" viewBox="0 0 16 16">
            ...
            <div className="d-flex align-items-center rcorners center-block">
              <div>
                <div className = "d-flex justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-bicycle" viewBox="0 0 16 16">
